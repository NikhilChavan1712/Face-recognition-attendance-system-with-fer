...
import os
from helpsupport1 import Helpsupport
...
# This part is image labels setting start 
        ...
        #title section
        title_lb1 = Label(bg_img,text="Face Recognition Attendance Management System",font=("verdana",30,"bold"),bg="white",fg="navyblue")
        ...
        # Photo   button 6
        pho_img_btn=Image.open(r"Images_GUI\emotion.jpg")
        ...
        pho_b1_1 = Button(bg_img,command=self.open_img,text="Emotion-Detect",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        ...
        dev_b1.place(x=810,y=330,width=180,height=180)

        dev_b1_1 = Button(bg_img,command=self.developr,text="Fee Reports",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        dev_b1_1.place(x=810,y=510,width=180,height=45)
