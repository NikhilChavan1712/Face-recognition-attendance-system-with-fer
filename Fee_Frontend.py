...
class Fee():
    def __init__(self, master):
        ...
        self.master.geometry('1366x800+0+0')
        ...
        # ==================================================Entries=================================================
        self.var_1 = DoubleVar(Frame_1, value='75000')
        ...
        self.sem_entry = ttk.Combobox(Frame_1, values=(' ', 'FIRST', 'SECOND', 'THIRD', 'FORTH'), font=('arial', 14), width=19,
