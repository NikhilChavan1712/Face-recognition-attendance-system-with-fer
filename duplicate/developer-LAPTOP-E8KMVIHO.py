...
# This part is image labels setting start 
        ...
        # ------------------------------------------------------------------------------------------------------------------- 
        # student button 1
        std_img_btn=Image.open(r"Images_GUI\m.png")
        ...
        std_b1_1 = Button(bg_img,text="Nikhil Chavan",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        std_b1_1.place(x=350,y=380,width=180,height=45)

        # Detect Face  button 2
        det_img_btn=Image.open(r"Images_GUI\m.png")
        ...
        det_b1_1 = Button(bg_img,text="Sanket Shinde",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
        det_b1_1.place(x=580,y=380,width=180,height=45)

         # Attendance System  button 3
        att_img_btn=Image.open(r"Images_GUI\m.png")
        ...
        att_b1_1 = Button(bg_img,text="Rohit Shinde",cursor="hand2",font=("tahoma",15,"bold"),bg="white",fg="navyblue")
