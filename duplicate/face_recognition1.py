...
class Face_Recognition:
    ...
    def mark_attendance(self,i,r,n):
        with open("Python-FYP-Face-Recognition-Attendence-System-master/attendance.csv","r+",newline="\n") as f:
    ...
    def face_recog(self):
        def draw_boundray(img,classifier,scaleFactor,minNeighbors,color,text,clf):
            ...
            for (x,y,w,h) in featuers:
                ...
                if confidence > 77:
                    cv2.putText(img,f"Student_ID:{i}",(x,y-80),cv2.FONT_HERSHEY_COMPLEX,0.8,(255,255,255),2)
